...
class HealthResponse(BaseModel):
    ...
    model_loaded: StrictBool = Field(description="Whether a TTS model is currently loaded")
    ...
    __properties: ClassVar[List[str]] = ["status", "model_loaded", "components", "cache", "model_name", "model_capabilities"]
