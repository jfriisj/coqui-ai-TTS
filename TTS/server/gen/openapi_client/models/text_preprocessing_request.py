...
class TextPreprocessingRequest(BaseModel):
    ...
    """ # noqa: E501
    text: Annotated[str, Field(min_length=1, strict=True, max_length=10000)] = Field(description="Text to preprocess")
    language: Optional[StrictStr] = Field(default='en', description="Language code for sentence segmentation")
