# adding-new-models - Task 13.2

Execute task 13.2 for the adding-new-models specification.
...
## Usage
```
/Task:13.2-adding-new-models
```

## Instructions

Execute with @spec-task-executor agent the following task: "Test registry file corruption recovery"

```
Use the @spec-task-executor agent to implement task 13.2: "Test registry file corruption recovery" for the adding-new-models specification and include all the below context.
...
## Task Details
- Task ID: 13.2
- Description: Test registry file corruption recovery

## Instructions
- Implement ONLY task 13.2: "Test registry file corruption recovery"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adding-new-models 13.2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adding-new-models 13.2 --mode complete
```
