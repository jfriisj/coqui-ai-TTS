# adding-new-models - Task 6.2

Execute task 6.2 for the adding-new-models specification.

## Task Description
Add examples for both Hugging Face and custom model entries

## Usage
```
/Task:6.2-adding-new-models
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add examples for both Hugging Face and custom model entries"

```
Use the @spec-task-executor agent to implement task 6.2: "Add examples for both Hugging Face and custom model entries" for the adding-new-models specification and include all the below context.
...
## Task Details
- Task ID: 6.2
- Description: Add examples for both Hugging Face and custom model entries

## Instructions
- Implement ONLY task 6.2: "Add examples for both Hugging Face and custom model entries"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adding-new-models 6.2 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adding-new-models 6.2 --mode complete
```
