# adding-new-models - Task 5.3

Execute task 5.3 for the adding-new-models specification.
...
## Usage
```
/Task:5.3-adding-new-models
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add troubleshooting section for common CLI errors"

```
Use the @spec-task-executor agent to implement task 5.3: "Add troubleshooting section for common CLI errors" for the adding-new-models specification and include all the below context.
...
## Task Details
- Task ID: 5.3
- Description: Add troubleshooting section for common CLI errors

## Instructions
- Implement ONLY task 5.3: "Add troubleshooting section for common CLI errors"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks adding-new-models 5.3 --mode complete
...
```bash
claude-code-spec-workflow get-tasks adding-new-models 5.3 --mode complete
```
