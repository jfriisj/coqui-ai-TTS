# implement-new-server-using-openapi-yaml-generated-api-and-models - Task 20

Execute task 20 for the implement-new-server-using-openapi-yaml-generated-api-and-models specification.

## Task Description
Create test utilities for generated models in tests/server_tests/test_generated_models.py

## Code Reuse
**Leverage existing code**: Existing test patterns from tests/aux
...
## Usage
```
/Task:20-implement-new-server-using-openapi-yaml-generated-api-and-models
```

## Instructions

Execute with @spec-task-executor agent the following task: "Create test utilities for generated models in tests/server_tests/test_generated_models.py"

```
Use the @spec-task-executor agent to implement task 20: "Create test utilities for generated models in tests/server_tests/test_generated_models.py" for the implement-new-server-using-openapi-yaml-generated-api-and-models specification and include all the below context.
...
## Task Details
- Task ID: 20
- Description: Create test utilities for generated models in tests/server_tests/test_generated_models.py
- Leverage: Existing test patterns from tests/aux
- Requirements: 2.3, 4.3

## Instructions
- Implement ONLY task 20: "Create test utilities for generated models in tests/server_tests/test_generated_models.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks implement-new-server-using-openapi-yaml-generated-api-and-models 20 --mode complete
...
```bash
claude-code-spec-workflow get-tasks implement-new-server-using-openapi-yaml-generated-api-and-models 20 --mode complete
```
