# update-main.py - Task 10

Execute task 10 for the update-main.py specification.

## Task Description
Add service isolation methods to ServiceIntegrator

## Code Reuse
**Leverage existing code**: TTS/server/services/service
...
Execute with @spec-task-executor agent the following task: "Add service isolation methods to ServiceIntegrator"

```
Use the @spec-task-executor agent to implement task 10: "Add service isolation methods to ServiceIntegrator" for the update-main.py specification and include all the below context.
...
## Task Details
- Task ID: 10
- Description: Add service isolation methods to ServiceIntegrator
- Leverage: TTS/server/services/service
- Requirements: 4.3, 4.4

## Instructions
- Implement ONLY task 10: "Add service isolation methods to ServiceIntegrator"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-main.py 10 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-main.py 10 --mode complete
```
