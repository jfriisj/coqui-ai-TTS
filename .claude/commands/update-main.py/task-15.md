# update-main.py - Task 15

Execute task 15 for the update-main.py specification.

## Task Description
Add error handling middleware to LightweightTTSServer

## Code Reuse
**Leverage existing code**: TTS/server/services/error
...
## Usage
```
/Task:15-update-main.py
```

## Instructions

Execute with @spec-task-executor agent the following task: "Add error handling middleware to LightweightTTSServer"

```
Use the @spec-task-executor agent to implement task 15: "Add error handling middleware to LightweightTTSServer" for the update-main.py specification and include all the below context.
...
## Task Details
- Task ID: 15
- Description: Add error handling middleware to LightweightTTSServer
- Leverage: TTS/server/services/error
- Requirements: 2.6, 3.5

## Instructions
- Implement ONLY task 15: "Add error handling middleware to LightweightTTSServer"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-main.py 15 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-main.py 15 --mode complete
```
