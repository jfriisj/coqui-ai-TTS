# update-main.py - Task 14

Execute task 14 for the update-main.py specification.

## Task Description
Add CORS configuration to LightweightTTSServer

## Code Reuse
**Leverage existing code**: existing CORS patterns from TTS/server/ FastAPI setup
...
Execute with @spec-task-executor agent the following task: "Add CORS configuration to LightweightTTSServer"

```
Use the @spec-task-executor agent to implement task 14: "Add CORS configuration to LightweightTTSServer" for the update-main.py specification and include all the below context.
...
## Task Details
- Task ID: 14
- Description: Add CORS configuration to LightweightTTSServer
- Leverage: existing CORS patterns from TTS/server/ FastAPI setup
- Requirements: 2.5

## Instructions
- Implement ONLY task 14: "Add CORS configuration to LightweightTTSServer"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-main.py 14 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-main.py 14 --mode complete
```
