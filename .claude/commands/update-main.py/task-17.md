# update-main.py - Task 17

Execute task 17 for the update-main.py specification.

## Task Description
Add service orchestration to main.py

## Code Reuse
**Leverage existing code**: all created service classes
...
Execute with @spec-task-executor agent the following task: "Add service orchestration to main.py"

```
Use the @spec-task-executor agent to implement task 17: "Add service orchestration to main.py" for the update-main.py specification and include all the below context.
...
## Task Details
- Task ID: 17
- Description: Add service orchestration to main.py
- Leverage: all created service classes
- Requirements: 5.4, 5.5

## Instructions
- Implement ONLY task 17: "Add service orchestration to main.py"
- Follow all project conventions and leverage existing code
- Mark the task as complete using: claude-code-spec-workflow get-tasks update-main.py 17 --mode complete
...
```bash
claude-code-spec-workflow get-tasks update-main.py 17 --mode complete
```
